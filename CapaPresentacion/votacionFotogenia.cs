...
{
    public partial class votacionFotogenia : Form
    {
        private Usuario usuario;
        public votacionFotogenia(Usuario oUsuario = null)
        {
            usuario = oUsuario;
            InitializeComponent();
        }

        private void votacionFotogenia_Load(object sender, EventArgs e)
        {
